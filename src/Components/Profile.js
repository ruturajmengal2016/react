...
function Profile({props}) {
    return (
        <div className="flex justify-center">
            <div className="flex justify-center flex-col mt-[10rem] bg-violet-500 p-12 w-[28rem] rounded-3xl font-serif h-[28rem] space-y-5 text-white border-2 border-gray-500">
